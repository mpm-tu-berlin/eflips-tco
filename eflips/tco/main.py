...
if __name__ == "__main__":
    ...
    tco_ann, tco_sp = calculate_tco(SCENARIO_ID, DATABASE_URL)

    print(f'The annual TCO is {tco_ann:.2f} EUR.')
    print(f'The specific TCO is {tco_sp:.2f} EUR/km.')


    if False:

        #TODO adapt these to a function of api
